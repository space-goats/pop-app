...
export var ENTRIES: Entry[] = [
  ...
  {"name": "ANSWER FILED",
   ...
   "help": "Pleading filed by Defendant to allege fault in this matter is on the Plaintiff"
 } ,
   ...
   "help": "This document asks the Court to	establish a custody and visitation arrangement."
 },
